...
# Fetch GitHub personal access token (PAT) from environment variable
GITHUB_TOKEN = os.getenv("GITHUB_TOKEN")
ORG_NAME = "sportngin"

# Check if the token is set in the environment
if not GITHUB_TOKEN:
    raise ValueError("GitHub token not set. Please set GITHUB_TOKEN as an environment variable.")
